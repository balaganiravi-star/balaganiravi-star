...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&pause=1000&color=2E5F8A&center=true&vCenter=true&width=600&lines=Building+scalable+enterprise+applications;Java+%7C+Spring+Boot+%7C+.NET+%7C+Azure;Microservices+%26+Cloud-Native+DevOps;Exploring+Agentic+AI+%F0%9F%A4%96" alt="Typing SVG" />
</p>

<p align="center">
  <a href="https://github.com/balaganiravi-star"><img src="https://komarev.com/ghpvc/?username=balaganiravi-star&label=Profile%20views&color=2E5F8A&style=flat" alt="profile views" /></a>
</p>
...
- 📄 Built automated enterprise document generation tooling (cover pages, TOCs, styled tables) with **Node.js**
- 🌱 Currently learning **Agentic AI** — Ollama, ChromaDB, CrewAI, LangGraph, RAG & multi-agent systems
...
![ETL](https://img.shields.io/badge/ETL_Pipelines-2E5F8A?style=for-the-badge&logoColor=white)
...
|---|---|---|
| 🛒 [**order-service-microservices**](https://github.com/balaganiravi-star/order-service-microservices) | Event-driven e-commerce backend with API gateway, service discovery, JWT auth, and resilient inter-service calls | Java 17, Spring Boot 3, Spring Cloud, Kafka, PostgreSQL, Docker |
| 📊 [**report-monitor-api**](https://github.com/balaganiravi-star/report-monitor-api) | Monitors scheduled report jobs, flags failures/SLA breaches, and sends alerts to a live dashboard | .NET 8, ASP.NET Core, EF Core, SQL Server, SignalR |
| ☁️ [**azure-blob-sync**](https://github.com/balaganiravi-star/azure-blob-sync) | Secure file ingestion service that syncs files to Azure Blob Storage with Entra ID auth and retry logic | C#, .NET, Azure Blob Storage, Microsoft Entra ID |
| 🔄 [**etl-data-pipeline**](https://github.com/balaganiravi-star/etl-data-pipeline) | Batch ETL pipeline that extracts, validates, transforms, and loads data into SQL Server with audit logging | Spring Batch, SQL Server, Docker |
| 📄 [**enterprise-docgen**](https://github.com/balaganiravi-star/enterprise-docgen) | Generates branded Word documents with cover page, TOC, color-coded tables, and page-numbered headers/footers | Node.js, docx |
| 🤖 [**research-buddy**](https://github.com/balaganiravi-star/research-buddy) | Multi-agent AI research assistant using RAG with local LLMs — fully free/open-source stack | Python, Ollama, ChromaDB, CrewAI, Streamlit |
...
<p align="center">
  <img height="170" src="https://github-readme-stats.vercel.app/api?username=balaganiravi-star&show_icons=true&theme=tokyonight&hide_border=true&count_private=true" alt="GitHub stats" />
  <img height="170" src="https://github-readme-stats.vercel.app/api/top-langs/?username=balaganiravi-star&layout=compact&theme=tokyonight&hide_border=true" alt="Top languages" />
</p>
...
<p align="center">
  ...
  <a href="https://github.com/balaganiravi-star"><img src="https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub" /></a>
</p>
